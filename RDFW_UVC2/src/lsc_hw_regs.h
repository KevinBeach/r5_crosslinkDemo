...
#define LSC_GUSB2PHYCFG_ENBLSLPM                    (0x00000001 << 8) /**< Enable utmi_sleep_n and utmi_l1_suspend_n USB2.0 HS/FS/LS PHY */
...
#define LSC_GUSB3PIPECTL_REQ_P1P2P3         (0x00000001 << 24) /**< Must be 1 for Synopsis PHY */
