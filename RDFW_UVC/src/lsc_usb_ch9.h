...
typedef struct {
    ...
    USB_STD_SS_DEVICE_CAP_DESC ss_dev_cap;
...
/**
 *  @brief USB Standard Interface Association Descriptor Structure.
 */
typedef struct {
    uint8_t bLength;
    uint8_t bDescriptorType;
    ...
    uint8_t iFunction;
} __attribute__ ((packed)) (USB_STD_IAD);
...
/**
 * @name Bit array elements as returned by the USB_REQ_GET_STATUS request.
 * @{
 */
